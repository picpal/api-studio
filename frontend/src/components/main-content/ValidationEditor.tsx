...
interface ValidationEditorProps {
    ...
    setValidationEnabled: React.Dispatch<React.SetStateAction<boolean>>;
    expectedValuesList: Array<{key: string, value: string, id: string}>;
    setExpectedValuesList: React.Dispatch<React.SetStateAction<Array<{key: string, value: string, id: string}>>>;
}

const ValidationEditor: React.FC<ValidationEditorProps> = ({ validationEnabled, setValidationEnabled, expectedValuesList, setExpectedValuesList }) => {
    return (
            ...
            {validationEnabled && (
                <div>
                    ...
                    <div className="mt-4 pt-3 border-t border-gray-200">
                        <button
                            onClick={() => {
                                const newId = (expectedValuesList.length > 0 ? Math.max(...expectedValuesList.map(ev => parseInt(ev.id))) : 0) + 1;
