          ...
          <div className="flex justify-end">
            <div className="flex items-center gap-2">
              <select
                ...
                className={`px-3 py-1.5 text-sm border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white min-w-48 ${historyList.length === 0 ? 'opacity-50 cursor-not-allowed' : ''
                  }`}
              >
                <option value="">
