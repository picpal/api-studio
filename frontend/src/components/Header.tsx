...
interface HeaderProps {
  ...
  currentPage?: 'api-testing' | 'test-automation' | 'pipeline-management' | 'documentation' | 'ui-testing';
  onNavigate?: (page: 'api-testing' | 'test-automation' | 'pipeline-management' | 'documentation' | 'ui-testing') => void;
}
