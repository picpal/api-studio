...
프로젝트를 처음 시작할 때, API Testing 페이지에서 사용할 샘플 데이터를 등록할 수 있습니다.
...
이 명령어를 실행하면:
- `test` 폴더 생성
- 5개의 샘플 API 테스트 케이스 등록 (JSONPlaceholder, HTTPBin)

### 수동 설정
1. http://localhost:3001 접속 후 로그인
2. API Testing 페이지에서 폴더 및 API 직접 추가
